...
--  ora_charset_id                number as ( nls_charset_id( case when upper(character_set) like 'UTF%8' then 'AL32UTF8' else character_set end ) ) virtual,
--  ora_charset_name              number as ( case when upper(character_set) like 'UTF%8' then 'AL32UTF8' else character_set end ) virtual,
