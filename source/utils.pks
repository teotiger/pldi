...
as
  ...
  -- This function returns the mimetype from a given filename.
  function mimetype(i_filename in varchar2) return varchar2 deterministic;

  -- This function returns the default directory for file access.
  function directory_setting return varchar2 deterministic;

  -- This function returns the maximum size of bytes in FILE_RAW_DATA.
