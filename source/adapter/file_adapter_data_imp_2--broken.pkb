...
-- verwendung in get_file_list und get_file
...
verkürzen mittels
    ...
    l_shared_strings:=extract_shared_strings(get_file('name vom datei'));
    l_format_codes:=extract_shared_strings(get_file('name vom datei'));
*/    
